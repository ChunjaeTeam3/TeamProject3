...
<section class="section has-background-primary is-relative testimonial-bg-shapes" >
    <div class="container">
        <div class="has-text-centered">
            <h2 class="section-title has-text-white" style="margin-bottom:50px;">소개</h2>
        </div>
            ...
            <div class="column is-10 testimonial-slider">
                <div class="has-text-centered testimonial-content">
                    ...
                    <p class="has-text-white mb-20">교육 정보가 한눈에, 학습 관리가 한번에 스마트한 학부모를 위한 토탈 교육 플랫폼! TSPOON로 완성하다.
                        <br><strong>내 아이의 하루를 담다! 부모의 하루를 열다!</strong>
                        ...
                        <strong>다른 알림장 앱 다운로드 없이 우리아이 학교 선생님이 등록한 과제 및 공지사항을 한번에 체크할 수 있습니다.</strong>
                    ...
                    <h4 class="has-text-white" style="font-weight: bold;">Tspoon</h4><br><br>
