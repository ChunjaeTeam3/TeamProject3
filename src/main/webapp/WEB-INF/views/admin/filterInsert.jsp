        ...
        <div class="columns">
            ...
            <div class="row column text-center">
                ...
                <div class="container">
                    <div>
                        <%--필터링 추가--%>
                        <form action="${path}/admin/filterInsert.do" class="columns is-multiline is-centered"
                              method="post">
                                ...
                                <c:forEach var="filter" items="${filterList}">
                                    <tr>
                                        <td class="has-text-centered" width="100"
                                            style="line-height: 40px"> ${filter.fno} </td>
                                        <td style="line-height: 40px"> ${filter.word} </td>
                                        <td class="has-text-centered" width="100" style="line-height: 40px"><a
                                                href="${path}/admin/filterDelete.do?fno=${filter.fno}&page=${curPage}"
                                                class="button has-text-centered is-primary"> 삭제 </a></td>
                                    </tr>
                                </c:forEach>
