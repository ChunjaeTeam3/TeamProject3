...
<div class="content" id="content" style="margin-top: 100px;">
    <div class="row column text-center" >
        <div class="container">
            <div class="button-group" style="margin-top: 30px; float: right; margin-bottom: 30px;">
            ...
            <table id="table">
                ...
                <tr style="border-bottom: solid #808080FF 1px;">
                    <td style="border-bottom: solid #808080FF 1px;"><p style="font-weight: bold;">이벤트 기간 | ${event.sdate } ~ ${event.edate}</p></td>
                </tr>
